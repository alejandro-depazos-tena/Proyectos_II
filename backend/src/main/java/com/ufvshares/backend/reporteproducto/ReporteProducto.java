...
public class ReporteProducto {
  ...
  @NotNull
  @Column(name = "id_producto_reportado", nullable = false)
  private Long idProductoReportado;
  ...
  public Long getIdProductoReportado() {
    return idProductoReportado;
  }

  public void setIdProductoReportado(Long idProductoReportado) {
